...
namespace RelationsNaN.Controllers
{
    public class GamesController : Controller
    {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var game = _context.Game.Include(g => g.Platforms).Where(g => g.Id == id).SingleOrDefault();
            if (game == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        public async Task<IActionResult> AddPlatform(int id, [Bind("Id,Name,Image,ReleaseYear,GenreId")] Game game)
        {
            if (id != game.Id)
            {
                return NotFound();
